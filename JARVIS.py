...
r = sr.Recognizer()
keyboard = Controller()
password = "2553"  # Replace with your actual password
...
def unlock_screen():
    os.system("xdotool type '{}'".format(password))
...
while(loopme == 1):
    if listen_for_wake_word():
        ...
        try:
            ...
            elif(t.find("power off") != -1):

                le = t.find("power off")+len("power off")+1
                t = t[le:]
